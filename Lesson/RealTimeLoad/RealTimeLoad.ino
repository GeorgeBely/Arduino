...
typedef struct ds1302_struct {
    ...
    uint8_t Date:4;           // День месяца. 1 - первый день
    uint8_t Date10:2;
    uint8_t reserved3:2;
    uint8_t Month:4;          // Месяц, 1 - Январь
    uint8_t Month10:1;
    uint8_t reserved4:3;
    uint8_t Day:3;            // День недели, 1 - понедельник
    uint8_t reserved5:5;
    uint8_t Year:4;           // Год, 0 - год 2000
    uint8_t Year10:4;
    uint8_t reserved6:7;
    uint8_t WP:1;
};
...
void setup() {
    ...
    #define SET_DATE_TIME_JUST_ONCE
        ...
        minutes    = 43;
        hours      = 13;
        dayofweek  = 6;  // День недели от 1...7
        dayofmonth = 17; // День месяца от 1...31
        month      = 9;  // Месяц от 1...12
        year       = 2016;
