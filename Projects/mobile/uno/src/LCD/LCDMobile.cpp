#include "Arduino.h"
#include "LCDMobile.h"
#include "../../../../../libraries/NewliquidCrystal_1.3.4/NewliquidCrystal/LCD.h"
#include "../../../../../libraries/NewliquidCrystal_1.3.4/NewliquidCrystal/LiquidCrystal_I2C.h"


/**
 * С помощью этой переменной будем отрисовывать данные на дисплей
 * Параметры     Addr, En, Rw, Rs, d4, d5, d6, d7, backligh pin, polarity  - почему так задаюся хз((
